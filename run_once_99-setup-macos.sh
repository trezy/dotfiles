...
if [[ $OSTYPE = *"darwin"* ]]; then
  ...
  # Expand the following File Info panes: “General”, “Open with”, and “Sharing &
  # Permissions”
  ...
  # Commented out because `disablelocal` has been removed
  ...
  #   ps aux | grep -v grep | grep -ic "${app}" &> /dev/null
